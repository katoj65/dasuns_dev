...
<div class="nk-header nk-header-fixed is-light shadow" style="border:none;">
...
<div class="dropdown-inner user-card-wrap d-none d-md-block" style="background:#45B39D;border-top:none;">
<div class="user-card" style="background:#45B39D;">
<div class="user-avatar" style="background:#0B5345;">
<em class="icon ni ni-user-alt-fill" style="font-size:20px;"></em>
</div>
<div class="user-info">
<span class="lead-text" style="text-transform:capitalize;color:#0B5345;font-size:17px;font-weight:bold;">

{{ user.usernames }}

</span>
<span class="sub-text" style="color:#0B5345;">
