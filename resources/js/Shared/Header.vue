...
<input type="text" class="form-control" placeholder="Search..." style="border:none;border-radius:10px 0 0 10px;background:#f8f9fa; outline: none;" v-model="form.search">
</div>
