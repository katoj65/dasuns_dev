...
<div class="card-header thick_bg border-bottom p-3" style="border-radius: 26px 26px 0 0;">
<h1 style="font-size:18px;text-align:center;letter-spacing:0.3px;word-spacing:1px;color:white;"> Create professional support service provider profile</h1>
</div>
