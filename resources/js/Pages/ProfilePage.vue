...
<!--Panalist profile---->
<profile-panelist :response="response" :errors="errors" :flash="flash" v-else-if="user.role=='panelist'"></profile-panelist>



<!---PSSU----->
<ProfilePSSU v-else-if="user.role=='pssu'" :response="response" :flash="flash" :errors="errors" ></ProfilePSSU>
