...
<select class="form-control form-control-lg" @change="select_role($event)">
<option value="">--Select--</option>
<option value="pssu">I need a service</option>
<option value="pssp">I want to provide a service</option>
<!-- <option value="other">Other</option> -->
</select>
</div>
</div>
