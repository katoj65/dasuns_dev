...
<div class="col-12 col-md-6 pt-3">
    ...
    <div class="card mt-2 mb-2">
        ...
        <div class="user-info">
        <h4 style="font-weight:bold;text-align:center;" class="text-center">
        ...
        <h1 style="text-align:center;font-size:18px;text-align:center;width:100%;"
         class="p-1 text-center">Create Your Profile</h1>
        </div>
